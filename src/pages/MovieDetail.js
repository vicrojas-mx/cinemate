...
export const MovieDetail = ({title}) => {
  ...
  useEffect(() => {
    async function fetchMovie() {
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=9c216fd5a05e211ec0a9afb791376d51&language=en-US`);
  ...
  return (
    <main>
      <section className="flex justify-around flex-wrap py-5">
        ...
        <div className="max-w-2xl text-grey-700 text-sm dark:text-white">
        ...
        <p className="my-4">
          ...
          <span to="">{movie.release_date}</span>
        </p>       
